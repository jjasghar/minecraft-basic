...
default[:minecraft_basic][:generator_settings] = default[:minecraft_basic][:allow_nether] = true
...
default[:minecraft_basic][:resource_pack_hash] = default[:minecraft_basic][:announce_player_achievements] = true
...
default[:minecraft_basic][:resource_pack] = default[:minecraft_basic][:spawn_animals] = true
...
default[:minecraft_basic][:level_seed] = default[:minecraft_basic][:use_native_transport] = true
